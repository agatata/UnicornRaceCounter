...
public class MainActivity extends Activity {
    @BindView(R.id.unicorn_a_score) TextView aScore;
    @BindView(R.id.unicorn_b_score) TextView bScore;
    @BindView(R.id.TenForA) Button addTenForA;
    @BindView(R.id.TenForA) Button addTenForB;
    ...
    public void displayForA(int score) {
        TextView scoreView = (TextView) aScore;
    ...
    public void displayForB(int score) {
        TextView scoreView = (TextView) bScore;
        scoreView.setText(String.valueOf(score));
    }
